...
const OrganizerManagementPage = () => {
  ...
  return (
    <div className="min-h-screen p-6 text-[19px]">
      <h1 className="text-3xl font-bold mb-6 text-white">Quản lý người tổ chức sự kiện</h1>
      ...
      <div className="p-4 rounded-xl shadow-lg mb-6 flex justify-between items-center">
        ...
        >
          <FaUserPlus className="mr-2" /> Thêm người tổ chức
        </button>
      </div>

      {/* User Table */}
      <motion.div  className="p-6 bg-white rounded-xl shadow-lg overflow-x-auto">
        <h1 className="text-2xl font-bold text-center mb-6 text-black">Danh sách người tổ chức</h1>
